...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pint-xarray-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11064&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pint-xarray-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pint-xarray` can be installed with:

```
conda install pint-xarray
```

It is possible to list all of the versions of `pint-xarray` available on your platform with:
